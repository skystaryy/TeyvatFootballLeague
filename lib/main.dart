...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      title: 'Teyvat Football Match App',
      theme: ThemeData(
          ...
          children: [
            ...
            TextField(
              decoration: InputDecoration(
                hintText: 'Find your favorite Teyvat club',
                border:
                ...
                child: Column(
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        Image.asset('assets/images/Inazuma.png', height: 40),
                        SizedBox(width: 20),
                        RichText(
                          text: TextSpan(
                            style: TextStyle(
                        ...
                        SizedBox(width: 20),
                        Image.asset('assets/images/Liyue.png', height: 40),
                      ],
                    ),
                    SizedBox(height: 10),
                    ElevatedButton(
            ...
            Expanded(
              child: SingleChildScrollView(
                ...
                child: Row(
                  children: [
                    FinishedMatchCard(
                      league: 'Teyvat League',
                      date: 'Yesterday',
                      team1Logo: 'assets/images/Inazuma.png',
                      team2Logo: 'assets/images/Mondstadt.png',
                      score: '3 : 1',
                    ),
                    SizedBox(width: 5),
                    FinishedMatchCard(
                      league: 'Teyvat League',
                      date: '01 August 2020',
                      team1Logo: 'assets/images/Sumeru.png',
                      team2Logo: 'assets/images/Fontaine.png',
                      score: '3 : 2',
                    ),
            ...
            ListTile(
              leading: CircleAvatar(
                backgroundImage: AssetImage(
                  'assets/images/Kazuha.png',
                ),
              ),
              title: Text('Top Player'),
              subtitle: Text('Kaedehara Kazuha'),
            ),
            SizedBox(height: 20),
            Text(
              'Match Stats',
